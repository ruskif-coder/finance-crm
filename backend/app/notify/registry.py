...
register(Event(
    ...
    title="МП не проверен",
    description=("У сделки есть медиаплан, но его никто не открывал и не визировал. Пока "
                 "аккаунт не отметил «Проверено», сделка стоит на первой стадии — "
                 "отправлять клиенту непроверенный план нельзя. Не важно, откуда план: "
                 "конвейер годового плана и ручной МП здесь равны."),
