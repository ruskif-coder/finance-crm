...
const ORPHAN_ALLOWED = new Set([
  ...
  '/exec',        // сводка руководителя: сквозной экран, не принадлежит ни одному контуру.
                  // Закрыт require_admin и открывается пиктограммой в панели — как настройки
                  // шестерёнкой, а «Операции» рублём. Пункта меню нет намеренно.
])
