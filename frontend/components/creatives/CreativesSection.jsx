...
export const T = {
  ...
  income: 'var(--income)', incomeFg: 'var(--income-fg)', incomeTint: 'var(--income-tint)', incomeBorder: 'var(--income-border)', incomeSoft: 'var(--income-border)',
  warning: 'var(--warning)', warningFg: 'var(--warning-text)', warningTint: 'var(--warning-tint)', warningBorder: 'var(--warning-border)',
  danger: 'var(--danger-fg)', dangerSoft: 'var(--danger)', dangerTint: 'var(--danger-tint)', dangerBorder: 'var(--danger-border)',
