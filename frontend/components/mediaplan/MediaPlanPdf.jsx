...
/* ══════════════════════════════════════════════════════════════════════
   ...
   Значения ОБЕЗЛИЧЕНЫ (2026-08-23): здесь стоял реальный медиаплан клиента
...
export const SAMPLE = {
  header: {
    ...
    subtitle: 'Simb-ad Альфарм / Таргет · Агентство · от 31.07.2026 · актуален 14 дней',
  },
  placementMeta: 'гео РФ · период месяц',
  params: [
    ['Агентство', 'Агентство', false], ['Рекламодатель', 'Рекламодатель', false],
    ['Бренд', 'Бренд', false], ['Название РК', 'Название кампании', false],
