 ...
 * пар с другой стороны. Ключ — КОМПЛЕКТ креатива (`root_set_id`): с 23.09.2026
 * доработка — новый порядковый креатив, а не подмена прежнего (владелец), и колонка с
 * тех пор держит сам комплект, а не корень цепочки.
 *
