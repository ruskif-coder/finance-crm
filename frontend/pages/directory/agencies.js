      ...
      <div style={{ padding: '20px 26px 50px', background: 'var(--bg-canvas)', minHeight: '100vh', fontFamily: UI }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap', marginBottom: formOpen ? 0 : 12 }}>
          ...
          <span style={{ marginLeft: 'auto', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
            ...
            {mayEdit && (
              <button style={{ background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 10, padding: '8px 15px', fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: UI }}
                    ...
                    {editId === a.id ? (
                      ...
                      <>
                        ...
                        <div style={{ ...cell, fontFamily: MONO, fontSize: 12, textAlign: 'right' }}>
                          {a.deals > 0 ? (
                            <a href={`/sales/deals?agency_id=${a.id}`} target="_blank" rel="noreferrer"
